...
\begin{beispiel}[K6 - PWLU ]{1} %PUNKTE DES BEISPIELS
			Gegeben sei eine Aussage über Logarithmen.
			
			\lueckentext{
							text={Die Hochzahl $x$, mit der man $a$ potenzieren muss, um $b$ zu erhalten heißt \gap von $b$ zur Basis $a$ wird mit \gap bezeichnet.}, 	%Lueckentext Luecke=\gap
