...
\begin{beispiel}[K6 - RF]{1} %PUNKTE DES BEISPIELS
			Frau Huber fährt täglich dieselbe Strecke zur Arbeit.
			
			Das Diagramm zeigt, wie die Fahrzeit $t$ von der mittleren Geschwindigkeit $v$ abhängt:
...
\end{pspicture*}}
			...
			\multiplechoice[6]{  %Anzahl der Antwortmoeglichkeiten, Standard: 5
							L1={Frau Huber fährt immer gleich schnell.},   %1. Antwortmoeglichkeit 
							L2={Frau Huber benötigt immer die gleiche Fahrzeit.},   %2. Antwortmoeglichkeit
							L3={Eine längere Fahrzeit benötigt eine höhere Geschwindigkeit.},   %3. Antwortmoeglichkeit
