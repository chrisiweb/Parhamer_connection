\section{K8 - SWS - 1005 - Welche Fläche ist gesucht - MC - Dimensionen Mathematik 8 - Schularbeiten-Trainer}

\begin{beispiel}[K8 - SWS]{1}
Eine Zufallsvariable $X$ ist normalverteilt mit $\mu=5$ und $\sigma=2$. Die Abbildung zeigt den Graphen der Dichtefunktion $f$ von $X$. Extrem- und Wendepunkte von $f$ sind in der Grafik eingezeichnet, ebenso eine Fläche der Größe A.
