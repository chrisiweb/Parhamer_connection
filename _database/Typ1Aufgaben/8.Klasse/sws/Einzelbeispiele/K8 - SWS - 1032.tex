...
Gegeben ist eine Hypothese über den Anteil $p_D$ defekter Stücke im Rahmen einer Qualitätskontrolle. Die Entscheidung wird auf Grundlage der Anzahl $x_D$ defekter Stücke in einer Stichprobe der Größe $n=500$ getroffen. Die Abbildung rechts veranschaulicht den Sachverhalt.
\begin{center}
...
\rput[tl](25.80448375955324,0.06398839964777926){Annahmebereich für}
...
\multiplechoice[5]{  %Anzahl der Antwortmoeglichkeiten, Standard: 5
				...
				L3={Im Falle, dass $x_D=30$ gilt, entscheidet man sich für die Arbeitshypothese.},   %3. Antwortmoeglichkeit
				L4={Für den Fall, dass $x_D=27$ gilt, kann die Richtigkeit der Nullhypothese als bewiesen angesehen werden.},   %4. Antwortmoeglichkeit
