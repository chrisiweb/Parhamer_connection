\section{K8 - SWS - 1033 - Partei-A-Wähler - MC - Dimensionen Mathematik 8 - Schularbeiten-Trainer}

\begin{beispiel}[K8 - SWS]{1}
Gegeben ist eine Hypothese über den Anteil $p_A$ der "`Partei-A-Wähler"' in der Grundmenge aller Personen, die bei einer bestimmten Wahl wahlberechtigt sind. Die Entscheidung wird auf Grundlage der Anzahl $x_A$ jener Personen getroffen, die in einer Stichprobe der Größe $n=300$ angegeben, dass sie die Partei A präferieren. Die Grafik unten veranschaulicht den Sachverhalt.
\begin{center}
...
\begin{scriptsize}
\rput[tl](84.22210729492039,0.06410713644439159){Annahmebereich für}
...
\multiplechoice[5]{  %Anzahl der Antwortmoeglichkeiten, Standard: 5
				...
				L3={Ein Ergebnis von $x_A=110$ stellt einen Beweis für die Richtigkeit der Arbeitshypothese dar.},   %3. Antwortmoeglichkeit
				L4={Für den Fall, dass $x_A=80$ gilt, fällt die Entscheidung zugunsten der Nullhypothese aus.},   %4. Antwortmoeglichkeit
				L5={Die Alternativhypothese lautet sinngemäß: Der Anteil der "`Partei-A-Wähler"' ist größer als 30\,\%.},	 %5. Antwortmoeglichkeit
