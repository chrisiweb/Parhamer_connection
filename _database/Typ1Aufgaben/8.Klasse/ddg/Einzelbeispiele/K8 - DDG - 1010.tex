...
Vervollständige gemäß der Abbildung die nachfolgende Tabelle und beschreibe die Abhängigkeit der $f'(x)$-Werte von den zugehörigen $x$- und/oder $f(x)$-Werten verbal.
...
\antwort{Die Werte der Funktion $f'$ ergeben sich durch Halbierung des zugehörigen $x$-Wertes, d.h. $f'(x)=\frac{1}{2}x \Rightarrow f(x)=\frac{1}{4}x^2$}
\end{beispiel}