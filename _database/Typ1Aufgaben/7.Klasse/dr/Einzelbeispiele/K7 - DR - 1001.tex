\section{K7 - DR - 1001 Änderungsraten - MC - Thema Mathematik Schularbeiten 7. Klasse}

\begin{beispiel}[K7 - DR]{1} %PUNKTE DES BEISPIELS
			  Die Abbildung zeigt den Graphen der Funktion $f$ mit der Gleichung\\ 
				$f(x)=0,1x^2$.
				
				Kreuze die beiden Aussagen an, die für die gegebene Funktion zutreffend sind!
				...
				\meinlr{\multiplechoice[5]{  %Anzahl der Antwortmoeglichkeiten, Standard: 5
								...
								L2={Die mittlere Änderungsrate in den Intervallen $[0;2]$ und $[2;4]$ ist gleich.},   %2. Antwortmoeglichkeit
								...
								L5={Die Steigung der Sekante durch die Punkte $A(3|f(3))$ und $B(6|f(6))$ ist größer als die momentane Änderungsrate an der Stelle $x=3$.},	 %5. Antwortmoeglichkeit
