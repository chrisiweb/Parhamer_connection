...
Ein Unternehmen stellt Bügeleisen her. Die Produktionskosten lassen sich näherungsweise durch die folgende Funktion $K$ beschreiben:\\
				...
				Der Graph der Erlösfunktion $E$ mit $E(x)=a\cdot x^2+b\cdot x$ für den Absatz von Bügeleisen ist in der nachstehenden Grafik dargestellt:
				\begin{center}
...
\psaxes[labelFontSize=\scriptstyle,xAxis=true,yAxis=true,Dx=10.,Dy=50.,ticksize=-2pt 0,subticks=2]{->}(0,0)(0.,0.)(124.93241379310332,288.8228571428449)[Menge in ME,140] [Erlös in GE,-40]
\psplot[linewidth=2.pt,plotpoints=200]{0}{100}{-0.1*(x-50.0)^(2.0)+250.0}
\rput[tl](81.41241379310338,178.28571428570675){E}
\end{pspicture*}}
				\end{center}
				
				Berechne die Höhe des Gewinns bei einer Produktion von 50\,ME, wenn die oben definierte Kostenfunktion $K$ zugrunde gelegt wird.
