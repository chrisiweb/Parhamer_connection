\section{K7 - KKK -  - 1046 - Parameterdarstellung - OA - Dimensionen Mathematik, Schularbeiten-Trainer 7. Klasse}

\begin{beispiel}[K7 - KKK]{1} %PUNKTE DES BEISPIELS
Eine Kurve $k$ wird durch nachfolgende Parameterdarstellung beschrieben:

$$k=\{X\in\mathbb{R}^2|X=(t+2\,|\,t^2-1),t\in\mathbb{R}\}$$
...
\antwort{\psplot[linewidth=1.2pt,plotpoints=200]{-2.420000000000002}{4.94}{x^(2.0)-4.0*x+3.0}}
\end{pspicture*}}
\end{center}

\antwort{Die Gleichung der zugehörigen Funktion lautet: $y=x^2-4x+3$.

(Quadratische Funktion, die jedem $x\in\mathbb{R}$ genau einen $y$-Wert zuordnet)}
				\end{beispiel}