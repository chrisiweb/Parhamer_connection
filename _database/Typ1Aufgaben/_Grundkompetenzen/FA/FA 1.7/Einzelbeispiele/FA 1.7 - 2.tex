...
Die grafische Darstellung veranschaulicht die Erzählung von einem Schulweg. 

\meinlr{
Die zurückgelegte Strecke s (in m) wird dabei in Abhängigkeit von der Zeit t (in min) dargestellt. \leer
