...
\begin{beispiel}[FA 1.5]{1} %PUNKTE DES BEISPIELS
				Skizziere den Graphen einer möglichen quadratischen Funktion, die in $P=(0|-1)$ ein lokales Minimum (einen Tiefpunkt) hat, und gib die Anzahl der Nullstellen dieser Funktion an.
				\begin{center}
