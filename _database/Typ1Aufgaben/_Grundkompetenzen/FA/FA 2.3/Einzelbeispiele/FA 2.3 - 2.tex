...
\multips(0,-4)(0,1.0){9}{\psline[linestyle=dashed,linecap=1,dash=1.5pt 1.5pt,linewidth=0.4pt,linecolor=lightgray]{c-c}(-4.72,0)(4.98,0)}
\multips(-4,0)(1.0,0){10}{\psline[linestyle=dashed,linecap=1,dash=1.5pt 1.5pt,linewidth=0.4pt,linecolor=lightgray]{c-c}(0,-4.3)(0,4.6)}
\psaxes[labelFontSize=\scriptstyle,xAxis=true,yAxis=true,Dx=1.,Dy=1.,ticksize=-2pt 0,subticks=2]{->}(0,0)(-4.72,-4.3)(4.98,4.6)[x,140] [f(x),-40]
\antwort{\psplot[linewidth=1.2pt,linecolor=ccqqqq,plotpoints=200]{-4.720000000000004}{4.9799999999999995}{2.0/3.0*x-1.0}}
\end{pspicture*}
\end{center}
