...
Das Volumen $V$ eines geraden quadratischen Prismas hängt von der Seitenlänge $a$ der quadratischen Grundfläche und von der Höhe $h$ ab. Es wird durch die Formel $V=a²\cdot h$ beschrieben.

Stelle die Abhängigkeit des Volumens $V(a)$ in $cm³$ eines geraden quadratischen Prismas von der Seitenlänge $a$ in cm bei konstanter Höhe $h=5\,cm$ durch einen entsprechenden Funktionsgraphen im Intervall $[0;4]$ dar!
\leer
