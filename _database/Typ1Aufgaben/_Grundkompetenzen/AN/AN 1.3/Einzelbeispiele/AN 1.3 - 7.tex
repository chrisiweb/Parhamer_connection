...
\multiplechoice[5]{  %Anzahl der Antwortmoeglichkeiten, Standard: 5
				L1={Im Intervall $[3; 6]$ ist die mittlere Änderungsrate annähernd 0\,°C/min. },   %1. Antwortmoeglichkeit 
				L2={Im Intervall $[0,5; 1,5]$ ist der Differenzenquotient größer als 25\,°C/min.},   %2. Antwortmoeglichkeit
				L3={Im Intervall $[0; 2]$ gibt es einen Zeitpunkt, in dem die momentane Änderungsrate
0\,°C/min beträgt. },   %3. Antwortmoeglichkeit
				L4={Der Differenzialquotient zum Zeitpunkt $t = 3$ ist annähernd -10\,°C/min.},   %4. Antwortmoeglichkeit
