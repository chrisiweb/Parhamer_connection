...
\begin{beispiel}[AN 4.2]{1} %PUNKTE DES BEISPIELS
				...
				Im nachstehenden Koordinatensystem sind die Graphen der beiden Funktionen $f$ und $g$ dargestellt. Schraffiere jene Fläche, deren Größe $A$ mit $A=\int^1_0{g(x)}$d$x$-$\int^1_0{f(x)}$d$x$ berechnet werden kann!
