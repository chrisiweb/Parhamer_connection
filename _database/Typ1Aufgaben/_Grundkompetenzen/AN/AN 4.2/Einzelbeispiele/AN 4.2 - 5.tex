...
$A=$\,\antwort[\rule{6cm}{0.3pt}]{$A=\displaystyle\int_1^2{f(x)\,\mathrm{d}x} - \displaystyle\int_{-2}^1{f(x)\,\mathrm{d}x}\text{ oder }\displaystyle\int_{-2}^2\left|f(x)\right|\,\mathrm{d}x$}
