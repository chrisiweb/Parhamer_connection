...
\multips(0,-2)(0,1.0){12}{\psline[linestyle=dashed,linecap=1,dash=1.5pt 1.5pt,linewidth=0.4pt,linecolor=lightgray]{c-c}(-1.7761488644641417,0)(11.80860741102746,0)}
\multips(-1,0)(1.0,0){14}{\psline[linestyle=dashed,linecap=1,dash=1.5pt 1.5pt,linewidth=0.4pt,linecolor=lightgray]{c-c}(0,-2.938334224369601)(0,8.927101335005048)}
...
\pscustom[fillcolor=black,fillstyle=solid,opacity=0.1]{\psplot{1.}{8.}{-0.09690716815660791*x^(3.0)+0.9628860178792948*x^(2.0)-0.5917508854812766*x-2.2742279642414105}\lineto(8.,5.)\psplot{8.}{1.}{0.2*x^(3.0)-2.6*x^(2.0)+9.8*x-9.4}\lineto(1.,-2.)\closepath}
