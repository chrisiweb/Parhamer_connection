...
Die 1. Ableitung $f'(x)=3x²-6x+3$ hat genau eine Nullstelle bei $x=1$ und hat sowohl links als auch rechts von der Nullstelle positive Werte. Damit ist die Funktion $f$ auf ihrem gesamten Definitionsbereich streng monoton wachsend und hat keine Extremstelle.
