...
\begin{langesbeispiel} \item[0] %PUNKTE DES BEISPIELS
				...
				\begin{center}\resizebox{0.6\linewidth}{!}{\includegraphics{../Bilder/Bild24-1.eps}}
				...
				\meinlr{\resizebox{1\linewidth}{!}{\includegraphics{../Bilder/Bild24-2.eps}}
								\begin{center}\begin{scriptsize}Abbildung 2\end{scriptsize}\end{center}}{\resizebox{1.4\linewidth}{!}{\includegraphics{../Bilder/Bild24-3.eps}}
