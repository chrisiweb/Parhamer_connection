...
Um den Flächeninhalt einer solchen trapezförmigen Schwimmzone berechnen zu können, kann die Formel $A(x,h)=h\cdot(180-2\cdot x+\sqrt{x²-h²})$ herangezogen werden.
