...
class Ui_MainWindow(object):
	...
	def setupUi(self, MainWindow):
		...
		self.comboBox_pruefungstyp.setItemText(1, _translate("MainWindow", "Wiederholungsschularbeit"))
		self.comboBox_pruefungstyp.setItemText(2, _translate("MainWindow", "Grundkompetenzcheck"))
	...
	def convert_jpgtoeps(self):
		...
		if ret==QtWidgets.QMessageBox.Yes:
			...
			filename = QtWidgets.QFileDialog.getOpenFileNames(None, 'Grafiken auswählen', os.path.dirname(self.saved_file_path), 'Bilder (*.jpg)')
			if filename[0]!=[]:
