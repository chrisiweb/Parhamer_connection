	...
	for i in range(5):
		try:
			...
			if not os.path.exists(config_path):
				input('The folder "_database" could not be found!\nPlace the folder in the same directory as LaMA or send a request to lama.helpme(at)gmail.com.\n\nMore information: lama.schule/downloads')
