...
all_nonogramms = {
    ...
    'luftballon': [
        "A0", "A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "A9", "B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "B9", "C0",
    ...
    'krankenwagen': [
        ...
        "F9", "G1", "G2", "G4", "G5", "G6", "G9", "H1", "H2", "H4", "H5", "H6", "H9", "I1", "I2", "I4", "I5", "I6", "I8", "I9",
    ...
    'instagram': [
        "A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "B0", "B9", "C0", "C9", "D0", "D4", "D5", "D9", "E0", "E3", "E6", "E9",
        "F0", "F3", "F6", "F9", "G0", "G4", "G5", "G9", "H0", "H2", "H9", "I0", "I9", "J1", "J2", "J3", "J4", "J5", "J6", "J7", "J8"
    ],
    'alien1': [
    ...
    'lama': [
        ...
        "E9", "F6", "F7", "G6", "G7", "H6", "H7", "H8", "H9", "I3", "I4", "I5", "I6", "I7", "I8", "I9"
    ]
}