...
all_nonogramms = {
    ...
    'babylöwe' : ["A0", "A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "A9", "B0", "B5", "B6", "B7", "B8", "B9", "C0", "C1", "C3", "C6", "C7",
    ...
    'snake': [
        "B0", "B1", "B2", "B3", "B4", "B5", "B6", "B7", "C7", "D2", "D3", "D4", "D5", "D6", "D7", "E2", "F2", "F3", "G3", "G4", "G5", "G6",
        "G7", "G8", "G9", "H9", "I3", "I6", "I7", "I8", "I9"
    ],
    'tetris': [
        "A3", "A9", "B2", "B3", "B8", "B9", "C2", "C6", "C9", "D5", "D6", "D7", "E7", "E8", "E9", "F9", "H0", "H1", "H2", "H3", "H8", "H9",
        "I8", "I9", "J6", "J7", "J8", "J9"
    ],
    'wecker': [
