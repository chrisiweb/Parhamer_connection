...
'fragezeichen' : ["B1", "B2", "C0", "C1", "C2", "D0", "E0", "E5", "E6", "E8", "E9",
"F0", "F5", "F6", "F8", "F9", "G0", "G4", "G5", "H0", "H1", "H2", "H3", "H4", "H5", "I1", "I2", "I3", "I4"],
'musiknoten': ["A7", "A8", "B6", "B7", "B8", "B9", "C6", "C7", "C8", "C9", "D1", "D2", "D3", "D4", "D5", "D6",
"D7", "D8", "E1", "E3", "F1", "F3", "G0", "G3", "G6", "G7", "H0", "H2", "H5", "H6", "H7", "H8", "I0", "I2", "I5",
"I6", "I7", "I8", "J0", "J1", "J2", "J3", "J4", "J5", "J6", "J7"],
'wecker': ["A1", "A2", "B0", "B1", "B3", "B4", "B5", "B6", "C0", "C2", "C3", "C4", "C5", "C6", "C7", "C9", "D1",
"D2", "D3", "D4", "D5", "D7", "D8", "D9", "E1", "E2", "E3", "E4", "E6", "E7", "E8", "F1", "F5", "F6", "F7", "F8",
"G1", "G2", "G3", "G4", "G5", "G6", "G7", "G8", "G9", "H0", "H2", "H3", "H4", "H5", "H6", "H7", "H9", "I0", "I1",
"I3", "I4", "I5", "I6", "J1", "J2"],
'haus': ["A4", "A5", "A6", "A7", "A8", "A9", "B3", "B4", "B5", "B6", "B7", "B8", "B9", "C2", "C3", "C4", "C5", "C6",
...
'hase': ["A5", "A6", "A7", "B4", "B5", "B6", "B7", "B8", "C0", "C1", "C2", "C3", "C4", "C5", "C6", "C8", "C9", "D0",
