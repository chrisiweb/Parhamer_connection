...
%\input{"../AG 4.2 - 001 Sinus und Cosinuswerte - MC".tex}
%\input{"../AG 4.2 - 002 Sinuswerte - OA".tex}

\foreach \i in {1,...,2000} {%
    \edef\FileName{"./Einzelbeispiele/AG 1.1 - "\i}%     The % here are necessary to eliminate any
