...
frame.grid(row=18, column=10, columnspan=6, sticky=W)
##################### Suche nach Klassen #######################
...
ws_cb_all=[]
ws_all=IntVar()
Button(hauptfenster, text='Wahrscheinlichkeit und Statistik:', command=ws_select_all,width=29).grid(column=c, row=r,sticky=W, columnspan=5)	
r+=1
for all in ws_kb:
	vars()[all]=IntVar()
