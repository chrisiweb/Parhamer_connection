...
def split_content_ausgleichspunkte_new_format(content):
    ...
    ausgleichspunkte_split_text = split_all_items_of_list(ausgleichspunkte_split_text, "\\item")
...
def split_content_ausgleichspunkte(content):
