...
% 10 dict begin
  ...
  % les 10 arêtes du cube : numéros des sommets des extrémités Paul Bourke
...
%
    ...
    % quelques idées du codage ont été prises à https://mikolalysenko.github.io/Isosurface/
